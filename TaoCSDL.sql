...
CREATE TABLE O (
	...
	CONSTRAINT O_PK PRIMARY KEY (IDPHONG,IDBENHNHAN),
	CONSTRAINT O_IDPHONG_FK FOREIGN KEY (IDPHONG) REFERENCES PHONG(ID),
	CONSTRAINT O_IDBENHNHAN_FK FOREIGN KEY (IDBENHNHAN) REFERENCES BENHNHAN(CMND_CCCD)
)
